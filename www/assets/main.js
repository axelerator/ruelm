...
var $author$project$Generated$Bindings$Connect = {$: 'Connect'};
var $author$project$Main$SentToBackend = function (a) {
	return {$: 'SentToBackend', a: a};
};
...
var $author$project$Generated$Bindings$toBackendEncoder = function (_enum) {
	return $elm$json$Json$Encode$string('Connect');
};
var $author$project$Main$sendToBackend = F2(
	function (sessionId, msg) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Generated$Bindings$toBackendEncoder(msg)),
				expect: $elm$http$Http$expectWhatever($author$project$Main$SentToBackend),
				url: '/send/' + sessionId
			});
	});
